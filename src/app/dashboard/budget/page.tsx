...
export default function BudgetPage() {
    ...
    const budgetsQuery = useMemoFirebase(() => {
        ...
        console.log('3a. Budgets query CREATED for tenantId:', tenantId);
    ...
    const categoriesQuery = useMemoFirebase(() => {
        ...
        console.log('3b. Categories query CREATED for tenantId:', tenantId);
    ...
    const expensesQuery = useMemoFirebase(() => {
        if (!firestore || !tenantId) {
         ...
         console.log('3c. Expenses query CREATED for tenantId:', tenantId);
        return query(
